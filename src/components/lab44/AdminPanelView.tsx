...
export default function AdminPanelView() {
  ...
  return (
    ...
    <p className="text-sm text-muted-foreground">System overview and VM management</p>
    </div>
    ...
    <p className="text-2xl font-bold text-emerald-700 dark:text-emerald-300">{approvedVmCount}</p>
    </div>
    </div>
    </CardContent>
    </Card>
    ...
    <p className="text-2xl font-bold text-amber-700 dark:text-amber-300">{pendingVmCount}</p>
    </div>
    </div>
    </CardContent>
    </Card>
    ...
    <p className="text-2xl font-bold text-violet-700 dark:text-violet-300">{labs.length}</p>
    </div>
    </div>
    </CardContent>
    </Card>
    ...
    {/* ─── Users Section (مرفوع للأعلى) ──────────────────────────────────── */}
    <Card className="shadow-sm mb-6">
    <CardHeader className="pb-3">
    <CardTitle className="text-base flex items-center gap-2">
    <Users className="h-4 w-4" /> Users
    <Badge variant="secondary" className="h-5 text-[10px] px-1.5">{students.length + instructors.length}</Badge>
    </CardTitle>
    <div className="mt-2">
    <Input
    ...
    {/* ─── VM Requests Section (الآن تحت Users) ──────────────────────────── */}
    <Card className="shadow-sm mb-6">
    <CardHeader className="pb-3">
    <CardTitle className="text-base flex items-center gap-2">
    <Server className="h-4 w-4" /> VM Requests
    {pendingVmCount > 0 && (
      <Badge className="bg-amber-500 text-white border-amber-500 h-5 text-[10px] px-1.5 animate-pulse">{pendingVmCount} pending</Badge>
    )}
    </CardTitle>
    </CardHeader>
    <CardContent className="p-0">
