    ...
    <motion.div {...fadeSlide} className="mx-auto max-w-7xl px-4 py-6 sm:py-8">
      ...
      <Card className="shadow-sm mb-6">
        <CardHeader className="pb-3">
          <CardTitle className="text-base">Active VM Assignments
            {deletedVmIds.size > 0 && (
              <Badge variant="outline" className="text-red-500 border-red-500/20 text-xs ml-1 align-middle">{deletedVmIds.size} deleted</Badge>
            )}
          </CardTitle>
          <CardDescription>Students with approved virtual machines</CardDescription>
        </CardHeader>
